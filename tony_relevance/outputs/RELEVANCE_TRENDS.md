...
Indexed to 2014 = 100. % change is 2014 → latest clean linear year for each show.
...
Viewers per 1,000 US TV households. If the line still falls, the decline is **not** merely 'fewer people own TVs'.
...
**Read:** the per-household decline is nearly as steep as the raw decline — cord-cutting explains only a sliver. The Tonys are losing the audience that *still owns a television*.

## 3. Share of the award-show audience (share of voice)

Tony viewers ÷ (Tony+Oscars+Emmys+Grammys) viewers, years where all four aired:

| Year | Tony share | Tony (M) | Big-four total (M) |
|---|---|---|---|
| 2014 | 7.4% | 7.00 | 94.8 |
| 2015 | 7.9% | 6.35 | 80.8 |
| 2016 | 10.9% | 8.70 | 79.5 |
...
**Read:** the Tonys' share of the big-four award-show audience went from **7.4%** (2014) to **10.2%** (2025). Theatre commands a shrinking slice of an already-shrinking pie.

## 4. The audience is the oldest in the business

| Award | Year | Median viewer age | Note |
|---|---|---|---|
| Tony | 2008 | 61.3 | Oldest median age of any award show surveyed. |
| Oscars | 2024 | 55.0 | Majority of 96th Oscars viewers were 55+; 18-34 only ~11%. |
| Emmys | 2008 | 52.1 |  |
| Oscars | 2008 | 49.5 |  |
| Grammys | 2008 | 45.2 | Youngest of the big four. |

**Read:** at a median age of ~61, the Tony audience is older than the Oscars (~50), Emmys (~52) and Grammys (~45). An award show whose viewers are aging out is, almost by definition, losing its grip on the culture being made *now*. (Sparse snapshots — backfill a full age panel to make this a trend, not a point.)

## 5. Most recent ceremonies (2024–2026)
