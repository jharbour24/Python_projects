...
| **2026 (79th)** | Aired **June 7, 2026** (Radio City Music Hall; host Pink; CBS's final contracted year). | **PENDING.** As of 2026-06-08 the official next-day Nielsen viewership had **not** been published — only winners coverage was out. Added as a row with `viewers_m = NULL`, `confidence = 'pending'`. **Deliberately not estimated.** Update when Deadline/Variety/Nielsen report it. |
